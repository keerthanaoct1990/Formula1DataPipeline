...
# MAGIC %md
# MAGIC we add a filter here because results is an incremental data, we only need to process new data. So first time it process data for 21/3, then 28/3 and 18/4 it won't rerun the previous date
